...
@RestController
@RequestMapping(value = "/api/fix-demo-error")
@ApiResponsesBase()
@Slf4j
public class DemoFixErrorController {
    ...
    static class Account {
        ...
        public synchronized boolean rutTien(Double tien) {
        ...
        public synchronized void nhanTien(Double tien) {
            Double currentBalance = getCurrentBalance();
            try {
                Thread.sleep(100);
            } catch (InterruptedException e) {
